...
def main():
    ...
    if testid == "aaclc_decode":
        ...
        stdin,stdout,stderr = dut.exec_command("aplay -v -Dhw:0,1 -r48000 -c2 -d10 -fS24_LE"+audioFileDir+"SENGKAI_48K_2CH_SINE_24_LE.wav & arecord -v -Dhw:0,1 -r48000 -c2 -d10 -fS24_LE "+rec_file_directory+rec_file)
        os.system("scp root@"+dev_1_ip+":"+rec_file_directory+rec_file+" "+rec_file_directory)
