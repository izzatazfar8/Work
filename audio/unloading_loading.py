...
def alsa_filter():
    ...
    stdin,stdout,stderr = dut.exec_command('cat /home/siv_test_collateral/siv_val-io-test-apps/audio/sut_check_alsa.log | cut -d " " -f 1 >> /home/siv_test_collateral/siv_val-io-test-apps/audio/f_sut_check_alsa.log')
...
def alsa_checker():
    ...
    stdin,stdout,stderr = dut.exec_command("dmesg | grep -i sound > /home/siv_test_collateral/siv_val-io-test-apps/audio/sut_check_alsa.log")
    alsa_filter()
    ...
    #if dut.exec_command("du -k /home/siv_test_collateral/siv_val-io-test-apps/audio/alsa_compare1.log | cut -f 1") == 0:
